export const APP_FEATURES = [
  {
    ...
    description:
      "Get interview questions and model answers based on your role, experience, and specific focus areas – no guesswork.",
  },
  {
    id: "02",
...
export const CARD_BG = [
  ...
  { id: 4, bgcolor: "linear-gradient(135deg, #fef2e9 0%, #fff8f3 100%)" },
  { id: 5, bgcolor: "linear-gradient(135deg, #e7f6fe 0%, #f4fafd 100%)" },
  { id: 6, bgcolor: "linear-gradient(135deg, #f5f5f5 0%, #fbfbfb 100%)" },
  { id: 7, bgcolor: "linear-gradient(135deg, #fff4fc 0%, #fff8f8 100%)" },
  { id: 8, bgcolor: "linear-gradient(135deg, #e8f8f3 0%, #f5fef8 100%)" },
